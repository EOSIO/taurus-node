...
const static uint32_t   default_deferred_trx_expiration_window       = 10*60; // deprecated. 10 minutes
const static uint32_t   default_max_trx_delay                        = 45*24*3600; // deprecated. 45 days
