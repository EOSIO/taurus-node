...
###############################################################################
# Producer HA Cluter Config Consistency Test - Quorum Size:
# Quorum size: 4 ===> 3
# Peers size: 5
# Step 1: Start a cluster of 5 nodes, wait them to sync up
# Step 2: Stop all 5 nodes
# Step 3: Relaunch the cluster of 5 nodes, changing quorum size in producer HA
#         config from 4 to 3 for each node, expecting failure
###############################################################################
...
try:
    ...
    # Step 3: Relaunch all 5 nodes with a different quorum size
    ...
    for i in range(len(nodes)):
        ...
        watch = "check failed - inconsistent quorum size"
