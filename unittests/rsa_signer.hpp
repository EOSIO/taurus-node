/* This implementation is adapated from wax-hapi, which is under MIT license.
For details, see https://github.com/worldwide-asset-exchange/wax-hapi */
...
namespace taurus {
   ...
   public:
      ...
      std::string sign(const std::string& message) const {
         ...
         boost::multiprecision::cpp_int pkcs1_encoding_big{ "0x" + pkcs1_encoding };
         boost::multiprecision::cpp_int modexp =
            boost::multiprecision::powm(pkcs1_encoding_big, private_exp_, modulus_);

         std::vector<char> result;
         boost::multiprecision::export_bits(modexp, std::back_inserter(result), 8);
