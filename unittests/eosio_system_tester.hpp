...
public:
   ...
   using base_type = Tester;

   eosio_system_tester(){}

   eosio_system_tester(controller::config config)
   : Tester(config) {
   }

   eosio_system_tester(controller::config config, const genesis_state& genesis)
   ...
   void setup() {
...

      {
         ...
         token_abi_ser.set_abi(abi, abi_serializer::create_yield_function( this->abi_serializer_max_time ));
      }
...

      {
         ...
         abi_def abi;
         BOOST_REQUIRE_EQUAL(abi_serializer::to_abi(accnt.abi, abi), true);
         abi_ser.set_abi(abi, abi_serializer::create_yield_function( this->abi_serializer_max_time ));
      }
   ...
   void create_accounts_with_resources( vector<account_name> accounts, account_name creator = config::system_account_name ) {
      for( auto a : accounts ) {
         this->create_account_with_resources( a, creator );
      }
   }
   ...
   action_result buyram( const account_name& payer, account_name receiver, const asset& eosin ) {
      return this->push_action( payer, "buyram"_n, mvo()( "payer",payer)("receiver",receiver)("quant",eosin) );
   }
   action_result buyrambytes( const account_name& payer, account_name receiver, uint32_t numbytes ) {
      return this->push_action( payer, "buyrambytes"_n, mvo()( "payer",payer)("receiver",receiver)("bytes",numbytes) );
   }

   action_result sellram( const account_name& account, uint64_t numbytes ) {
      return this->push_action( account, "sellram"_n, mvo()( "account", account)("bytes",numbytes) );
   }
   ...
   action_result push_action( const account_name& signer, const action_name &name, const variant_object &data, bool auth = true ) {
         ...
         act.name = name;
         act.data = abi_ser.variant_to_binary( action_type_name, data, abi_serializer::create_yield_function( this->abi_serializer_max_time ) );
   ...
   asset get_balance( const account_name& act ) {
      ...
      return data.empty() ? asset(0, symbol(CORE_SYMBOL)) : token_abi_ser.binary_to_variant("account", data, abi_serializer::create_yield_function( this->abi_serializer_max_time ))["balance"].template as<asset>();
   }

   fc::variant get_total_stake( const account_name& act ) {
      vector<char> data = this->get_row_by_account( config::system_account_name, act, "userres"_n, act );
      return data.empty() ? fc::variant() : abi_ser.binary_to_variant( "user_resources", data, abi_serializer::create_yield_function( this->abi_serializer_max_time ) );
   }
   ...
   fc::variant get_voter_info( const account_name& act ) {
      ...
      return data.empty() ? fc::variant() : abi_ser.binary_to_variant( "voter_info", data, abi_serializer::create_yield_function( this->abi_serializer_max_time ) );
   }
   ...
   fc::variant get_producer_info( const account_name& act ) {
      ...
      return abi_ser.binary_to_variant( "producer_info", data, abi_serializer::create_yield_function( this->abi_serializer_max_time ) );
   }
   ...
   fc::variant get_stats( const string& symbolname ) {
      ...
      return data.empty() ? fc::variant() : token_abi_ser.binary_to_variant( "currency_stats", data, abi_serializer::create_yield_function( this->abi_serializer_max_time ) );
   }
   ...
   fc::variant get_global_state() {
      ...
      return data.empty() ? fc::variant() : abi_ser.binary_to_variant( "eosio_global_state", data, abi_serializer::create_yield_function( this->abi_serializer_max_time ) );
   ...
   fc::variant get_refund_request( name account ) {
      ...
      return data.empty() ? fc::variant() : abi_ser.binary_to_variant( "refund_request", data, abi_serializer::create_yield_function( this->abi_serializer_max_time ) );
   }
   ...
   abi_serializer initialize_multisig() {
      abi_serializer msig_abi_ser;
      {
         ...
         msig_abi_ser.set_abi(msig_abi, abi_serializer::create_yield_function( this->abi_serializer_max_time ));
      }
      return msig_abi_ser;
   }
   ...
   vector<name> active_and_vote_producers() {
      ...
      this->transfer( name("eosio"), name("alice1111111"), core_from_string("650000000.0000"), name("eosio") );
      ...
      std::vector<account_name> producer_names;
      {
         ...
         this->setup_producer_accounts(producer_names);
      ...
      //vote for producers
      {
         this->transfer( config::system_account_name, name("alice1111111"), core_from_string("100000000.0000"), config::system_account_name );
   ...
   void cross_15_percent_threshold() {
      this->setup_producer_accounts({"producer1111"_n});
